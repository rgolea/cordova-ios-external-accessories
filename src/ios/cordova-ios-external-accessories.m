/********* cordova-ios-external-accessories.m Cordova Plugin Implementation *******/
...
@interface ExternalAccessories : CDVPlugin {
}
...
@property (nonatomic, retain) ExternalAccessories* plugin;
...
-(id) initWithPlugin:(ExternalAccessories*)thePlugin session:(EASession*)theSession callbackId:(NSString*)theCallbackId;
-(id) initWithPlugin:(ExternalAccessories*)thePlugin fromPaused:(NSDictionary*)paused;
-(void) writeData;
...
@implementation ExternalAccessories
